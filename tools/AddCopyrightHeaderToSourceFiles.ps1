$lineBreak = "`r`n"
$noticeTemplate = "//-----------------------------------------------------------------------$lineBreak// <copyright file=`"[FileName]`" company=`"Akka.NET Project`">$lineBreak//     Copyright (C) 2009-2017 Lightbend Inc. <http://www.lightbend.com>$lineBreak//     Copyright (C) 2013-2017 .NET Foundation <https://github.com/akkadotnet/akka.net>$lineBreak// </copyright>$lineBreak//-----------------------------------------------------------------------$lineBreak$lineBreak"

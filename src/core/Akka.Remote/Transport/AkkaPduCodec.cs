...
namespace Akka.Remote.Transport
{
    ...
    internal abstract class AkkaPduCodec
    {
        ...
        /// implementation fall back to <see cref="DecodeMessage(ReadOnlySequence{byte},IRemoteActorRefProvider,Address)"/>.
        /// </summary>
        ...
        {
            return DecodeMessage(raw, provider, localAddress);
        }

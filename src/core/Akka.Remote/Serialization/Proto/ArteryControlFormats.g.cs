...
namespace Akka.Remote.Serialization.Proto.Msg {
    ...
    static ArteryControlFormatsReflection() {
      byte[] descriptorData = global::System.Convert.FromBase64String(
          string.Concat(
            ...
            "dWlkGAEgASgEIiAKCEZsdXNoQWNrEhQKDGV4cGVjdGVkQWNrcxgBIAEoBUIC",
            "SAFiBnByb3RvMw=="));
      descriptor = pbr::FileDescriptor.FromGeneratedCode(descriptorData,
          ...
          new pbr::GeneratedClrTypeInfo(null, new pbr::GeneratedClrTypeInfo[] {
            ...
            new pbr::GeneratedClrTypeInfo(typeof(global::Akka.Remote.Serialization.Proto.Msg.FlushAck), global::Akka.Remote.Serialization.Proto.Msg.FlushAck.Parser, new[]{ "ExpectedAcks" }, null, null, null)
          }));
    }
    #endregion
  ...
  internal sealed partial class FlushAck : pb::IMessage<FlushAck> {
    private static readonly pb::MessageParser<FlushAck> _parser = new pb::MessageParser<FlushAck>(() => new FlushAck());
    [global::System.Diagnostics.DebuggerNonUserCodeAttribute]
    public static pb::MessageParser<FlushAck> Parser { get { return _parser; } }

    [global::System.Diagnostics.DebuggerNonUserCodeAttribute]
    public static pbr::MessageDescriptor Descriptor {
      get { return global::Akka.Remote.Serialization.Proto.Msg.ArteryControlFormatsReflection.Descriptor.MessageTypes[10]; }
    }
    ...
    [global::System.Diagnostics.DebuggerNonUserCodeAttribute]
    public FlushAck(FlushAck other) : this() {
      expectedAcks_ = other.expectedAcks_;
    }

    [global::System.Diagnostics.DebuggerNonUserCodeAttribute]
    public FlushAck Clone() {
      return new FlushAck(this);
    }

    /// <summary>Field number for the "expectedAcks" field.</summary>
    public const int ExpectedAcksFieldNumber = 1;
    private int expectedAcks_;
    [global::System.Diagnostics.DebuggerNonUserCodeAttribute]
    public int ExpectedAcks {
      get { return expectedAcks_; }
      set {
        expectedAcks_ = value;
      }
    }
    ...
    [global::System.Diagnostics.DebuggerNonUserCodeAttribute]
    public override bool Equals(object other) {
      return Equals(other as FlushAck);
    }

    [global::System.Diagnostics.DebuggerNonUserCodeAttribute]
    public bool Equals(FlushAck other) {
      if (ReferenceEquals(other, null)) {
        return false;
      }
      if (ReferenceEquals(other, this)) {
      ...
      if (ExpectedAcks != other.ExpectedAcks) return false;
      return true;
    }
    ...
    public override int GetHashCode() {
      int hash = 1;
      if (ExpectedAcks != 0) hash ^= ExpectedAcks.GetHashCode();
      return hash;
    }
    ...
    public void WriteTo(pb::CodedOutputStream output) {
      if (ExpectedAcks != 0) {
        output.WriteRawTag(8);
        output.WriteInt32(ExpectedAcks);
      }
    }
    ...
    public int CalculateSize() {
      int size = 0;
      if (ExpectedAcks != 0) {
        size += 1 + pb::CodedOutputStream.ComputeInt32Size(ExpectedAcks);
      }
      return size;
    }

    [global::System.Diagnostics.DebuggerNonUserCodeAttribute]
    public void MergeFrom(FlushAck other) {
      if (other == null) {
        return;
      }
      if (other.ExpectedAcks != 0) {
        ExpectedAcks = other.ExpectedAcks;
      }
    }
